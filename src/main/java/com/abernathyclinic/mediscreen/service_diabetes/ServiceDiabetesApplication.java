...
@EnableSwagger2
public class ServiceDiabetesApplication {

	public static void main(String[] args) {
		SpringApplication.run(ServiceDiabetesApplication.class, args);
	}
	...
	public Docket swaggerConfigurationBean() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.abernathyclinic.mediscreen.service_diabetes.controller"))
